          ...
          {activeProject && (
            <div className="flex items-center justify-between px-4 py-2 border-b" style={{ borderColor: 'var(--nexus-border-primary)' }}>
              ...
              <div className="flex items-center gap-1">
                ...
                <button onClick={() => setShowSettings(true)} className="text-[10px] px-2 py-1 rounded-md flex items-center gap-1" style={{ backgroundColor: 'var(--nexus-bg-secondary)', border: '1px solid var(--nexus-border-primary)', color: 'var(--nexus-text-tertiary)' }}>
